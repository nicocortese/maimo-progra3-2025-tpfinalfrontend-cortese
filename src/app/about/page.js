        ...
        <div className="-mt-20 bg-[#1a1a1a] rounded-2xl shadow-2xl border-t-4 border-[#dac07d] p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-12 items-start">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                <strong className="text-[#dac07d]">OlympicHub</strong> nació como un proyecto universitario en la 
                <span className="font-semibold text-[#fefcf4]"> Universidad Maimónides</span>, dentro de la materia <em>Diseño de Interfaces</em>.
              </p>
              
              <p className="text-lg text-gray-300 leading-relaxed">
                La idea original era crear una aplicación pensada para jóvenes fanáticos del deporte 
                que quisieran seguir de cerca todo lo relacionado con los Juegos Olímpicos, 
                ofreciendo datos precisos, biografías de atletas y un seguimiento en tiempo real.
              </p>
            </div>
            ...
            <div className="w-full md:w-1/3 bg-[#272727] p-8 rounded-xl border border-[#dac07d]/20 shadow-lg">
               ...
               <ul className="space-y-6">
                 <li className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-[10px] text-gray-500 uppercase font-bold">Universidad</p>
                      <p className="text-[#fefcf4] font-medium">MAIMÓNIDES</p>
                    </div>
                 </li>
                 <li className="flex items-start gap-4">
                    <div className="w-5 h-5 rounded-full bg-[#dac07d] flex items-center justify-center text-[#1a1a1a] font-bold text-xs mt-1">2025</div>
                    <div>
                      <p className="text-[10px] text-gray-500 uppercase font-bold">Carrera</p>
                      <p className="text-[#fefcf4] font-medium">TECNOLOGÍA MULTIMEDIAL</p>
                    </div>
                 </li>
                 <li className="flex items-start gap-4">
                    <FaMedal className="text-gray-400 text-xl mt-1" />
                    <div>
                      <p className="text-[10px] text-gray-500 uppercase font-bold">Objetivo</p>
                      <p className="text-[#fefcf4] font-medium">INFORMACIÓN OLÍMPICA</p>
                    </div>
                 </li>
               </ul>
            </div>
