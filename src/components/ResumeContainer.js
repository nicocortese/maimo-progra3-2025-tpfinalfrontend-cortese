...
const resumeData = [
  ...
  },
  {
    ...
    resume:
      "En los 800m libres masculinos Daniel Wiffen (IRL) consiguió el oro con un tiempo récord olímpico, Bobby Finke (USA) se llevó la plata y Gregorio Paltrinieri (ITA) completó el podio.",
    category: ["RESUMEN DEL DÍA"],
  ...
  },
  {
    ...
    resume:
      "Revisa los ganadores de las medallas de oro del tercer día de competencia y sus increíbles logros.",
    category: ["RESUMEN DEL DÍA"],
  ...
  },
  {
    ...
    title: "Final - 52kg (F)",
    resume:
      "Se celebró en el Gran Palais Éphémere. Diyora Keldiyorova (UZB) se colgó la medalla de oro, Distria Krasniqi (KOS) la de plata.",
  ...
  },
  {
    ...
    resume:
      "El partido por la medalla de oro entre China y Corea del Norte se celebró en el París Sur Arena. China se llevó el oro con un resultado final de 4-2.",
    category: ["RESUMEN DEL DÍA"],
  ...
  },
  {
    ...
    resume:
      "Resumen de la competición de cuartos de final de scull individual masculino en remo que se celebró en el Estadio Náutico Vaires-sur-Marne!",
    category: ["RESUMEN DEL DÍA"],
...
const ResumeContainer = () => {
  ...
  const checkIsFavorite = (itemTitle) => {
    return favorites.some(
      (fav) => fav.name === itemTitle || fav.athlete === itemTitle
    );
  };
  ...
  return (
    <section className="w-full py-6 px-4 md:px-0 relative z-10">
      <h3 className="text-3xl md:text-4xl font-bold text-[#fefcf4] mb-6 pl-10">
        Resumen día 3 (29 de julio){" "}
      </h3>
