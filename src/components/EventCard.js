...
import { FaMedal } from "react-icons/fa"; // Icono placeholder para disciplinas

const EventCard = ({ item, type, isFavorite, onToggleFavorite }) => {
  const onLive = Math.random() > 0.5;

  return (
    <div className="w-[140px] h-[159px] md:w-[180px] md:h-[200px] rounded-xl overflow-hidden relative group shadow-lg transition-transform hover: scale-105">
      <div className="relative z-10 flex flex-col justify-between h-full p-3 text-[#fefcf4]">
        ...
        <div className="flex justify-between items-end pb-1">
          ...
          <button
            ...
            className="text-[#dac07d] hover:text-amber-600 transition-colors"
          >
            {isFavorite ? (
